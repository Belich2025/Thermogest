    ...
    <Modal onClose={onClose} w={620}>
      ...
      <div style={{ display:"flex",flexDirection:"column",gap:10,padding:isMobile?"12px 10px":"14px 20px" }}>
        ...
        <div>
          ...
          <div style={{ display:"flex",gap:6 }}><textarea value={form.observaciones} onChange={e=>upd("observaciones",e.target.value)} placeholder="Recomendaciones al cliente..." style={{...inp(),flex:1,minHeight:40,resize:"vertical",fontSize:13}}/><button type="button" onClick={()=>startVoiceSimple(t=>upd("observaciones",form.observaciones?form.observaciones+" "+t:t))} style={{ width:34,height:34,borderRadius:8,border:`1px solid ${T.border}`,background:T.card,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0 }}><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke={T.accent} strokeWidth="2" strokeLinecap="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/></svg></button></div>
        </div>
