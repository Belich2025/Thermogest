...
import { PS_ORDER }        from "../../constants/status.js";
import Btn                 from "../ui/Btn.jsx";
import Badge               from "../ui/Badge.jsx";
import BadgeProg           from "../ui/BadgeProg.jsx";
import PresupuestoDetalle    from "../shared/PresupuestoDetalle.jsx";
import NuevoPresupuestoModal from "../shared/NuevoPresupuestoModal.jsx";

export default function PresupuestosList({ data, refresh, user, empresa={}, onTooltip }) {
  const { T, PS } = useTheme();
  ...
  return (
    <div style={{ padding:isMobile?12:28 }}>
      <div style={{ display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:16 }}>
        ...
        <button onClick={()=>onTooltip?.("presupuestos")} title="Ayuda de Presupuestos" style={{ width:32,height:32,borderRadius:"50%",background:T.surface,border:`1.5px solid ${T.border}`,color:T.muted,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,fontWeight:700,marginRight:8 }}>?</button>
